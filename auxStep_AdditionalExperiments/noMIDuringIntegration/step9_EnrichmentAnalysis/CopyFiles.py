...
copyfile('step8_StageSpec_CorePreds/output/CorePreds.pkl', f'{copy_to}/CorePreds_noMI.pkl') 
...
copyfile('step9_Literature_Validation/output/CorePreds/CorePreds_LitValid.pkl', f'{copy_to}/CorePreds_LitValid_ALL.pkl') 
