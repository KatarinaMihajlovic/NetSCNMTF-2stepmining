...
EXPs_ctrl = pd.read_csv('input/ExpressionMatrix/Normalized_data_Control.zip', index_col=0)
EXPs_pink1 = pd.read_csv('input/ExpressionMatrix/Normalized_data_PINK1.zip', index_col=0)
EXPs = pd.concat([EXPs_ctrl,EXPs_pink1],axis=1)
...
del cell_conds_2_singlecells['Control_D10']
cell_conds.remove('Control_D10')
